...
plt.xlabel('Number of Male Students Who Pass Algebra 1 in 9th/10th Grade')
plt.ylabel('Number of Schools')
plt.title('Number of Male 9th/10th-Grade Students Who Passed Algebra 1')
plt.savefig('./figure/algpassG0910Male.png')

plt.figure(2)
plt.hist(mFemale[idxF], 50)
plt.xlabel('Number of Female Students Who Pass Algebra 1 in 9th/10th Grade')
plt.ylabel('Number of Schools')
plt.title('Number of Female 9th/10th-Grade Students Who Passed Algebra 1')
plt.savefig('./figure/algpassG0910Female.png')
print('stop')