...
plt.xlabel('Number of Male 11th/12th-Grade Algebra 1 Students')
plt.ylabel('Number of Schools')
plt.title('Number of Male 11th/12th-Grade Students Enrolled in Algebra 1')
plt.savefig('./figure/algenrlG1112Male.png')

plt.figure(2)
plt.hist(mFemale[idxF], 50)
plt.xlabel('Number of Female 11th/12th-Grade Algebra 1 Students')
plt.ylabel('Number of Schools')
plt.title('Number of Female 11th/12th-Grade Students Enrolled in Algebra 1')
plt.savefig('./figure/algenrlG1112Female.png')
print('stop')