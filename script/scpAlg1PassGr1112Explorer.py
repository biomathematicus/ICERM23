...
plt.xlabel('Number of Male Students Who Pass Algebra 1 in 11th/12th Grade')
plt.ylabel('Number of Schools')
plt.title('Number of Male 11th/12th-Grade Students Who Passed Algebra 1')
plt.savefig('./figure/algpassG1112Male.png')

plt.figure(2)
plt.hist(mFemale[idxF], 50)
plt.xlabel('Number of Female Students Who Pass Algebra 1 in 11th/12th Grade')
plt.ylabel('Number of Schools')
plt.title('Number of Female 11th/12th-Grade Students Who Passed Algebra 1')
plt.savefig('./figure/algpassG1112Female.png')
print('stop')