...
plt.xlabel('Number of Male 8th-Grade Algebra 1 Students')
plt.ylabel('Number of Schools')
plt.title('Number of Male 8th-Grade Students Enrolled in Algebra 1')
plt.savefig('./figure/algenrlG08Male.png')

plt.figure(2)
plt.hist(mFemale[idxF], 50)
plt.xlabel('Number of Female 8th-Grade Algebra 1 Students')
plt.ylabel('Number of Schools')
plt.title('Number of Female 8th-Grade Students Enrolled in Algebra 1')
plt.savefig('./figure/algenrlG08Female.png')
print('stop')